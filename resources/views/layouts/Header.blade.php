...
<head>
	...
	<meta name="description"
		content="At Ambrosia Restaurant Ltd., we believe food is more than sustenance—it's about connection and celebration. Each dish is crafted with love, bringing flavors that tell a story. Join us at Chattogram’s finest dining spot to savor moments with those you cherish.">
	<!-- FavIcons -->
...
<body>
	...
	<div id="page">
		...
		<header id="gtco-header" class="gtco-cover gtco-cover-md" role="banner"
			style="background-image: url(images/img_bg_2.jpg); height:200px;" data-stellar-background-ratio="0.5">
				...
				<div class="gtco-container">
					...
					<div class="row d-flex align-item-center">
						<div class="col-sm-4 col-xs-12">
							...
							<div id="gtco-logo" class="logo2"><a href="{{ url('/') }}"><img src="images/Logo2.png"
										alt="AMBROSIA" /></a></div>
							<div id="gtco-logo" class="logo"><a href="{{ url('/') }}"><img src="images/Logo.png"
										alt="AMBROSIA" /></a></div>
						</div>
						<div class="col-xs-8 text-right menu-1">
							<ul>
								<li><a style="color:#FFFFFF;font-weight:bold;" href="{{ route('about') }}">About</a>
								</li>
								<li><a style="color:#FFFFFF;font-weight:bold;"
								...
								<li><a style="color:#FFFFFF;font-weight:bold;" href="{{ route('gallery') }}">Gallery</a>
								</li>
								<li><a style="color:#FFFFFF;font-weight:bold;" href="{{ route('contact') }}">Contact</a>
								</li>
							</ul>
						</div>
					</div>
